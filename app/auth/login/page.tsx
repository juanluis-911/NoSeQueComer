    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">NoSeQuéComer</h1>
          <p className="text-gray-500 mt-1 text-sm">Tu asistente de recetas del día</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-2xl py-3 px-4 bg-white font-medium text-gray-700 hover:bg-gray-50 active:scale-95 transition-all mb-4 disabled:opacity-50"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ¿No tienes cuenta?{' '}
          <Link href="/auth/register" className="text-[#E63946] font-medium">
            Regístrate
          </Link>
        </p>
      </div>
